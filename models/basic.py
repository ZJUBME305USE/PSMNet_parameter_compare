...
class PSMNet(nn.Module):
    def __init__(self, maxdisp, use_dilation, use_ssp):
        super(PSMNet, self).__init__()
        self.maxdisp = maxdisp
        self.use_dilation = use_dilation
        self.use_ssp = use_ssp
        self.feature_extraction = feature_extraction(use_dilation, use_ssp)
    ...
    def forward(self, left, right):
        refimg_fea = self.feature_extraction(left, self.use_dilation, self.use_ssp)
        targetimg_fea = self.feature_extraction(right, self.use_dilation, self.use_ssp)
